...
<!--      <el-checkbox v-model="showReviewer" class="filter-item" style="margin-left:15px;" @change="tableKey=tableKey+1">
    ...
    <!--  <el-table-column :label="$t('table.date')" width="150px" align="center">
      ...
      <el-table-column :label="$t('table.sName')" min-width="100px">
        <template slot-scope="{row}">
...
<script>
import { fetchList, fetchPv, createArticle, updateArticle,updateStockDp } from '@/api/article'
...
export default {
  ...
  data() {
    return {
      ...
      importanceOptions: ['金融板块', '医疗板块', '科技板块','消费板块','农业板块','金属板块'],
      calendarTypeOptions,
      sAbilityTypeOptions,
      sStatusTypeOptions,
